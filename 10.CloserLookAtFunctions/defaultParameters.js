...
2. If a argument is not passed in a function argument then the value is undefined for that argument.
3. Defining default parameter value by adding value with equal to sign. In ES5 we had to check for a value with a OR operator, if the value existed then the value was shown else default value was shown.
...
5. If you want to skip the value from the function call then you can do it by passing undefined in place of it. Then the default parameter will be used.
*/
